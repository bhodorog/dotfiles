...
;; ;; force emacs to split new windows vertically
;; (setq
...
(use-package projectile
  ...
  (projectile-register-project-type
    'python-pkg2 '("pyproject.toml")
    :project-file "pyproject.toml"
    :compile "python -m build"  ;; see https://pypa-build.readthedocs.io/en/latest/
    :test "hatch run cov" ;; there is no default cov command. One needs to be defined (generated by default by hatch new)
    :test-prefix "test_"
    :test-suffix "_test"
  )
)
...
;; life-saver to discover shortcuts for various modes
